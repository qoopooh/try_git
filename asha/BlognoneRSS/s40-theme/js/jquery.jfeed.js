...
var acceptContentType = ['text/xml', 'application/xml', 'application/rdf+xml', 'application/atom+xml', 'application/rss+xml'];
...
function checkContentType(cType){
	for(i=0; i<acceptContentType.length; i++){
		if(acceptContentType[i].toLowerCase() == cType.toLowerCase())
			return true;
	}
